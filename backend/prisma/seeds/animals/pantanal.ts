...
export async function pantanal() {
  ...
  const cervoDoPantanalData: Prisma.AnimalCreateInput = {
    ...
    threats: {
      connect: [{ name: 'Desmatamento' }, { name: 'Caça' }, { name: 'Hidrelétricas' }, { name: 'Agropecuária' }, { name: 'Expansão Urbana' }],
    },
  };
  ...
  const tamanduaBandeiraData: Prisma.AnimalCreateInput = {
    ...
    conservationStatus: 'VU',
    description: 'O tamanduá-bandeira é uma espécie endêmica do continente americano ocorrendo em vários países des o sul de Belize e Guatemala na América Central até a América do Sul. No Brasil está presente em todos os biomas brasileiros. Com aparência bastante característica: pelagem marrom com uma faixa diagonal preta de borda brancas, o tamanduá-bandeira costuma medir de 1 a 1,2m de comprimento total e pesar em média 31,5kg.\nAs principais ameaças à espécie são as queimadas, a expansão agropecuária, o desmatamento, o aumento da matriz rodoviária e a desconexão e redução do habitat natural. Outras ameaças secundárias são: caça, perseguição e envenamento indireto por inseticidas.\nCuriosidadess: O tamanduá-bandeira é um bom nadador.',
    biome: {
      connect: {
        name: 'Pantanal',
      },
