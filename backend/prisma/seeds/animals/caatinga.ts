...
export async function caatinga() {
  ...
  const araraAzulDeLearIcon = buildPrismaImage(
    animals["arara_azul_de_lear"]["icon"],
  );
  const araraAzulDeLearImages = animals["arara_azul_de_lear"]["images"].map((
    image: string,
  ...
  const guigoDaCaatingaIcon = buildPrismaImage(
    animals["guigo_da_caatinga"]["icon"],
  );
  const guigoDaCaatingaImages = animals["guigo_da_caatinga"]["images"].map((
    image: string,
  ) => buildPrismaImage(image));
  ...
  const queixadaImages = animals["queixada"]["images"].map((image: string) =>
    buildPrismaImage(image)
  );
  ...
  const soldadinhoDoAraripeIcon = buildPrismaImage(
    animals["soldadinho_do_araripe"]["icon"],
  );
  const soldadinhoDoAraripeImages = animals["soldadinho_do_araripe"]["images"]
  ...
  const tatuBolaImages = animals["tatu_bola"]["images"].map((image: string) =>
    buildPrismaImage(image)
  );
