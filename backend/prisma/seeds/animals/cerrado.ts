...
export async function cerrado() {
  ...
  const loboGuaraData: Prisma.AnimalCreateInput = {
    ...
    conservationStatus: 'VU',
    description:
      'O lobo-guará é uma espécie que, originalmente, se distribuía amplamente pelas áreas de vegetação aberta do Cerrado, Chaco e Pampas.\nNa região do Pantanal a espécie é comum nas partes altas da bacia do alto Paraguai, mas raro na planície Pantaneira. Países de ocorrência: Argentina, Bolívia, Brasil, Paraguai, Peru, Uruguai.\nA perda de habitat por desmantamento e a ocupação urbana são as principais causas da diminuição de sua população.\n',
    biome: {
      connect: {
        name: 'Cerrado',
      },
